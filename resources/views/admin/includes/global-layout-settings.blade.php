    <div
        ...
        <a href="#" class="block py-3 px-4 transition-all hover:bg-primary-500/10"
    ...
    <div class="offcanvas pct-offcanvas !w-[320px] offcanvas-end !z-[1031]" tabindex="-1" id="offcanvas_pc_layout"
        ...
        <div class="offcanvas-header">
            <h5 id="offcanvas_pc_layoutLabel">Configurações</h5>
            ...
            <ul class="rounded-lg *:py-4 divide-y divide-inherit border-theme-border dark:border-themedark-border">
                <li class="list-group-item">
                    <div class="pc-dark">
                        ...
                        <p class="text-muted text-sm mb-4">Escolha o modo claro, escuro ou automático</p>
                ...
                <li class="list-group-item">
                    ...
                    <p class="text-muted text-sm mb-4">Escolha o contraste do tema</p>
                ...
                <li class="list-group-item">
                    ...
                    <p class="text-muted text-sm mb-4">Escolha a cor principal do seu tema</p>
                ...
                <li class="list-group-item">
                    ...
                    <p class="text-muted text-sm mb-4">Escolha o seu layout</p>
                    <div class="theme-main-layout flex items-center gap-1 w-full">
                        <a href="#" class="preset-btn btn btn-img active"
                            data-value="vertical">
                        ...
                        <a href="#" class="preset-btn btn btn-img" data-value="horizontal">
                            <img src="{{ asset('admin/assets/images/customizer/horizontal.svg') }}" alt="img" class="img-fluid" />
                        </a>
                        <a href="#" class="preset-btn btn btn-img" data-value="color-header">
                            <img src="{{ asset('admin/assets/images/customizer/color-header.svg') }}" alt="img"
                                class="img-fluid" />
                        </a>
                        <a href="#" class="preset-btn btn btn-img" data-value="compact">
                            <img src="{{ asset('admin/assets/images/customizer/compact.svg') }}" alt="img" class="img-fluid" />
                        </a>
                        <a href="#" class="preset-btn btn btn-img" data-value="tab">
                            <img src="{{ asset('admin/assets/images/customizer/tab.svg') }}" alt="img" class="img-fluid" />
                        </a>
                    </div>
                </li>
                <li class="list-group-item">
                    <h6 class="mb-1">Legendas do Menu</h6>
                    <p class="text-muted text-sm mb-4">Mostrar/Ocultar legendas do menu lateral</p>
                ...
                <li class="list-group-item">
                    <div class="pc-rtl">
                        <h6 class="mb-1">Direção do Layout</h6>
                        <p class="text-muted text-sm mb-4">Esquerda para Direita / Direita para Esquerda</p>
                            ...
                            <div class="col-span-6">
                                <div class="grid">
                                    <button class="preset-btn btn-img btn active" data-value="false"
                                        ...
                                        <img src="{{ asset('admin/assets/images/customizer/ltr.svg') }}" alt="img"
                                            class="img-fluid" />
                                    </button>
                                </div>
                            </div>
                            <div class="col-span-6">
                                <div class="grid">
                                    <button class="preset-btn btn-img btn" data-value="true"
                                        ...
                                        <img src="{{ asset('admin/assets/images/customizer/rtl.svg') }}" alt="img"
                                            class="img-fluid" />
                                    </button>
                                </div>
                            </div>
                ...
                <li class="list-group-item pc-box-width">
                    <div class="pc-container-width">
                        ...
                        <p class="text-muted text-sm mb-4">Escolha layout completo ou em container</p>
                        <div class="grid grid-cols-12 gap-6 theme-color theme-container">
                            <div class="col-span-6">
                                <div class="grid">
                                    <button class="preset-btn btn-img btn active" data-value="false"
                                        onclick="change_box_container('false')">
                                        <img src="{{ asset('admin/assets/images/customizer/full.svg') }}" alt="img"
                                            class="img-fluid" />
                                    </button>
                                </div>
                            </div>
                            <div class="col-span-6">
                                <div class="grid">
                                    <button class="preset-btn btn-img btn" data-value="true"
                                        ...
                                        <img src="{{ asset('admin/assets/images/customizer/fixed.svg') }}" alt="img"
                                            class="img-fluid" />
                                    </button>
                                </div>
                            </div>
                ...
                <li class="list-group-item">
                    <div class="grid">
                        <button class="btn btn-light-danger" id="layoutreset">Restaurar Layout</button>
                    </div>
                </li>
            </ul>
        </div>
