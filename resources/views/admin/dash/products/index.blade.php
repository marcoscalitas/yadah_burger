...
@section('content')
    ...
    @include('admin.dash.components.breadcrumb', [
        'title' => 'Produtos ',
        'items' => [['label' => 'Produtos', 'url' => route('admin.products.index')]],
    ])
    <!-- [ breadcrumb ] end -->
            ...
            <div class="card table-card">
                <div class="card-header">
                    <div class="sm:flex items-center justify-between">
                        <h5 class="mb-3 sm:mb-0">Produtos</h5>
                        <div>
                            <a href="../admins/course-teacher-apply.html" class="btn btn-outline-secondary mr-1">Apply
                                Utilizadores</a>
                            <a href="{{ route('admin.products.create') }}" class="btn btn-primary">Adicionar
                                Produto</a>
                        </div>
                    </div>
                </div>
