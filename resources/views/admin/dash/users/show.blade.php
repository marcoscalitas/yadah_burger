                ...
                <div class="tab-pane">
                    <div class="grid grid-cols-12 gap-6">
                        <div class="col-span-12 lg:col-span-4 2xl:col-span-3">
                                ...
                                <div class="card-body relative">
                                    <div class="absolute right-0 top-0 p-[25px]">
                                        <button type="button"
                                            ...
                                            data-pc-toggle="modal" data-pc-target="#editPhotoModal"
                            ...
                            <!-- Modal Editar Foto -->
                            <div id="editPhotoModal" class="modal fade" tabindex="-1" role="dialog"
                                aria-labelledby="editPhotoModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <form id="photoUploadForm" class="form-with-csrf-token"
                                            ...
                                            <div class="modal-body text-center">
                                                ...
                                                <!-- Preview fixo -->
                                                <div class="preview-wrap mx-auto relative"
                                        ...
                                        object-position:center center;display:block;max-width:none;">
                                            ...
                                            <div class="modal-footer flex justify-center gap-3 border-t">
                                                <label for="profilePhotoInput"
                                                    class="btn btn-outline-primary cursor-pointer px-4">
                                ...
                                <div class="card-header flex items-center justify-between">
                                    ...
                                    <div class="shrink-0">
                                        <a href="{{ route('admin.users.edit', $user->id) }}" class="btn btn-primary">
                                            <i class="ti ti-edit"></i> Editar {{ $user->getShortName() }}
                                        </a>
                                    </div>
                                </div>
                                <div class="card-body">
